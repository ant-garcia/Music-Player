...
public class SwingAudioPlayer extends JFrame implements ActionListener {
	...
	private ArrayList <String> audioPathNameList = new ArrayList<String>();
		...
		else if(source instanceof JToggleButton)
		{
			...
			if(item == openFile){
				...
				if(aboutFlag == false){
					...
					aboutDisabled.setText("MMC Music Player V0.60");
					aboutFlag = true;
				}
			...
			public void run() 
			{
				try{
					...
					{	
						...
						String songName = p.audioFileNameList.get(listIndex).substring(p.audioFileNameList.get(listIndex).lastIndexOf(File.separator) + 1);
						System.out.println(songName);
						labelFileName.setText("Playing File: " + songName);
					}
					else
					{
						player.load(audioFilePath);
						String songName = audioFileName.substring(audioFileName.lastIndexOf(File.separator) + 1);
						System.out.println(songName);
						labelFileName.setText("Playing File: " + songName);
					}
